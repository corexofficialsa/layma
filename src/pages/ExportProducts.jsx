                    ...
                    <Link to={`/products/${product.id}`} style={{ textDecoration: 'none' }}>
                      ...
                      >
                        ...
                        <div className="exp-prod-card-body" style={{ padding: '18px 20px 22px' }}>
                          <div className="exp-prod-origin" style={{ fontSize: 14, color: '#5C8C46', letterSpacing: 1, marginBottom: 6, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{product.origin}</div>
