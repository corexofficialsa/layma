...
const offerings = [
  ...
  { icon: '📋', title: 'Quality Certification & Documentation', desc: 'All products come with complete documentation — lab test reports, certificates of origin, and relevant food safety certifications for GCC market compliance.' },
];
